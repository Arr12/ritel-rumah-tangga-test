        ...
        <>
            <div className="py-14 px-5 md:px-10 bg-green-50 flex flex-row items-center justify-between">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <ion-icon name="chevron-forward-outline"></ion-icon>
                    <p className="mx-2 text-sm font-bold">PROFIL</p>
                </div>
            </div>
            <div className="flex flex-col-reverse md:flex-row items-start px-10 pt-10 mb-10">
                <div className="w-full mt-5 md:mt-0 md:w-2/3 lg:w-9/12 pr-10">
                    <div className="mb-5">
                        <h2 className="font-bold text-xl mb-3">
                            Hello, <b className="text-slate-700">Undefined</b>
                        </h2>
                        <p>
                            Dari Dasbor Akun Saya, Anda dapat melihat cuplikan
                            aktivitas akun terkini dan memperbarui informasi akun
                            Anda. Pilih tautan di bawah untuk melihat atau mengedit
                            informasi.
                        </p>
                    </div>
                    <div className="my-5">
                        <div className="flex flex-col my-10">
                            <h2 className="font-bold text-xl mb-3">Informasi Akun</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 items-start mt-3">
                                <div className="flex flex-col pr-5">
                                    <div className="flex flex-row bg-green-50 items-center justify-between px-4 py-3">
                                        <h3 className="font-bold">Kontak Informasi</h3>
                                    </div>
                                    <div className="p-5">
                                        <h4 className="font-bold text-lg">Wenzy</h4>
                                        <p className="mt-3">info@example.com</p>
                                        <p onClick={() => setInformationDetailModal(true)} className="mt-5 cursor-pointer text-red-400">Edit Profil</p>
                                    </div>
                                </div>
                                <div className="flex flex-col pl-5">
                                    ...
                                    <div className="flex flex-col p-5">
                                        <div className="my-3">
                                            ...
                                            <p>
                                                123, The Company Name Inc, Street Road City name,
                                                State name and Zip code.
                                            </p>
                                            <p onClick={() => setAddressDetailModal(true)} className="mt-5 cursor-pointer text-red-400">Edit Alamat</p>
                                        </div>
                                        <div className="my-3">
                                            <h2 className="font-bold text-base mb-3">
                                                Alamat Pengiriman
                ...
                <div className="flex flex-col w-full md:w-2/3 lg:w-1/4 pt-10 items-center bg-gray-100">
                    ...
                    <div className="flex flex-col justify-start w-full">
                        <div className="p-4 cursor-pointer bg-white" onClick={() => window.location.replace('/buyer/profile')}>
                            <p className="text-base">Informasi Akun</p>
                        </div>
                        <div className="p-4 cursor-pointer" onClick={() => window.location.replace('/buyer/profile/info')}>
