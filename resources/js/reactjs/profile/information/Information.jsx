        ...
        <>
            <div className="py-14 px-5 md:px-10 bg-green-50 flex flex-row flex-wrap items-center justify-between">
                ...
                <div className="flex flex-row items-center mt-3">
                    ...
                    <p className="mx-2 text-sm font-bold">INFORMATION</p>
                </div>
            </div>
            <div className="flex flex-col-reverse md:flex-row items-start px-4 md:px-10 pt-10 mb-10">
                <div className="w-full mt-5 md:mt-0 md:w-2/3 lg:w-9/12 pr-10 flex flex-col lg:flex-row items-start ml-0 md:ml-5">
                    <div className="mb-10">
                        <h2 className="font-bold text-xl mb-3">
                            Profil
                        </h2>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Nama</h4>
                            <p>Undefined</p>
                        </div>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Alamat Email</h4>
                            <p>info@example.com</p>
                        </div>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Phone Number</h4>
                            <p>(+62) 812345678</p>
                        </div>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Kota</h4>
                            <p>-</p>
                        </div>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Alamat</h4>
                            <p>-</p>
                        </div>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Kode Pos</h4>
                            <p>60211</p>
                        </div>
                        <div className="flex flex-row items-center mb-3">
                            <h4 className="w-44">Tahun Bergabung</h4>
                            <p>(+62) 812345678</p>
                        </div>
                    </div>
                    <div className="mb-5 ml-0 lg:ml-14">
                        <div className="flex flex-col justify-start">
                            <h3 className="mb-5 font-bold text-lg">Login Details</h3>
                            <div className="flex flex-row items-center mb-3">
                                <h4 className="w-44">Alamat Email</h4>
                                <p>info@example.com</p>
                            </div>
